...
fn create_vertices(ul: f32, vl: f32) -> (Vec<Vertex>, Vec<u16>) {
    let (pos, normal, uv, ind, _) = vd::create_sphere_data(2.5, 20, 32);
...
impl State {
    async fn new(window: &Window, sample_count: u32) -> Self {
        ...
        let material = [0.1 as f32, 0.4, 0.2, 25.0, 1.0];
        init.queue
        ...
        let img_files = vec!["assets/earth.png", "assets/earth-normal.png"];
        ...
        match event {
            WindowEvent::KeyboardInput {
                ...
                VirtualKeyCode::Space => {
                    ...
                    let material = [0.1 as f32, 0.4, 0.001, 20.0, self.gamma_correction as f32];
...
fn main() {
    ...
    let window = winit::window::WindowBuilder::new()
        .build(&event_loop)
        .unwrap();
    window.set_title(&*format!("{}", "sphere_normal"));
